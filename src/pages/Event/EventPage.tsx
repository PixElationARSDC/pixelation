        ...
        <div className='event-page'>
            <SimpleGrid columns={{ base: 1, md: 4 }} gap={8}>
                <GridItem colSpan={{ base: 1, md: 2 }}>
                    <Left name='FILMMAKING WORKSHOP' location='SEM HALL 1' date='31/01/25' time='STARTING 11:30 AM' agenda="An an <b>immersive learning experience</b> designed to guide you through the intricacies of filmmaking, from conceptualizing ideas to crafting visually stunning narratives." />
                </GridItem>
