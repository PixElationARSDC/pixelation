                ...
                <SimpleGrid columns={{ base: 1, md: 4 }} gap={8}>
                    <GridItem colSpan={{ base: 1, md: 2 }}>
                        <Left 
                            ...
                            agenda="An immersive learning experience designed to guide you through the intricacies of filmmaking, from conceptualizing ideas to crafting visually stunning narratives." 
                        />
                    </GridItem>
